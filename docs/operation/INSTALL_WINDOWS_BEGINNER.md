# 🟢 BEGINNER — No technical knowledge needed
...
- ☐ The installer file your helper sent you (named **`NemesisAgent-Setup.exe`**).
- ☐ About **5 minutes**.

That's it. You do **not** need any passwords, accounts, or settings.

## Installing

1. **Find the file** your helper sent you — `NemesisAgent-Setup.exe` (check your
   Desktop, Downloads folder, or the message they sent).
2. **Double-click it.**
3. If Windows asks *"Do you want to allow this app to make changes?"*, click
   **Yes.** This is safe — you downloaded it from your own security system.
4. **Watch the little progress bar.** It takes about 2 minutes. You'll see
   friendly messages like "Installing..." and "Connecting...".
...
Just one thing to do — don't worry, nothing is broken:

> **Text [SUPPORT_CONTACT] and say: "Nemesis install showed an error."**

If you saw a red message, a photo of the screen helps. Your helper takes it
from there.

## Your privacy

Nemesis protects your **connection**. It never reads your personal files,
messages, or passwords. It's only there to keep your device safe.
